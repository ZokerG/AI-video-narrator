...
CALIBRATION_FILE = "src/infrastructure/tts/voice_calibration.json"
...
def calibrate_voice(voice_id: str, language: str = "es", style: str = "viral") -> float:
    ...
    from src.infrastructure.tts.tts_service import generate_audio_for_beat, get_audio_duration
    ...
    test_file = f"src/temp/outputs/_calibration_{voice_id}.mp3"
